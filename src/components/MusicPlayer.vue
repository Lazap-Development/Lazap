              ...
              <div class="nexto">
                ...
                <div class="family">
                  <div class="button" id="MusicPlayer-backward-btn">
                    <img
                      src="../assets/svg/music/angle-left-solid.svg"
                      alt=""
                    />
                  </div>
                  ...
                  <div class="button" id="MusicPlayer-forward-btn">
                    <img
                      src="../assets/svg/music/angle-right-solid.svg"
                      alt=""
                    />
                  </div>
                </div>
...
export default {
  ...
  async mounted() {
    ...
    document
      .getElementById("MusicPlayer-forward-btn")
      .addEventListener("click", async function () {
    ...
    document
      .getElementById("MusicPlayer-backward-btn")
      .addEventListener("click", async function () {
    ...
    function updatePlayer(data) {
      ...
      document.getElementById("music-progress").innerHTML =
        convertMillisecondsToMinutesSeconds(data.progress);
      document.getElementById("music-total").innerHTML =
        convertMillisecondsToMinutesSeconds(data.duration);
      ...
      if (status) {
        ...
        slider.style.background = `linear-gradient(to right, rgba(var(--accent-color), 0.7) 0%, rgba(var(--accent-color), 0.7) ${
...
.rightbar .musicPlayer .bkg {
  ...
  justify-content: center;
  align-items: center;
  box-shadow: 0px 2.3px 4.6px rgba(0, 0, 0, 0.11),
...
.rightbar .musicPlayer .nexto .button {
  ...
  margin: 3px;
  box-shadow: 0px 5px 10px rgba(0, 0, 0, 0.35), 0px 40px 80px rgba(0, 0, 0, 0.7);
}
