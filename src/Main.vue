<template>
  ...
  <div class="bg" id="bg">
    ...
    <div class="secondorybox" id="games">
      ...
      <p>All Games</p>
      <svg id="addGameBtn" class="addGameBtn" version="1.1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="459.325px" height="459.325px"
        viewBox="0 0 459.325 459.325" style="enable-background:new 0 0 459.325 459.325;" xml:space="preserve">
        <g>
...
export default {
  ...
  load() {
    import(`./components/listeners.vue`);
