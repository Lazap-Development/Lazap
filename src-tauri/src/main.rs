...
fn init_storage() -> Result<(), std::io::Error> {
    ...
    if !Path::new(&base_config_ld_file).exists() {
        ...
        writeln!(file, "{{ \"enable_rpc\": true, \"launch_on_startup\": false, \"skip_login\": false, \"tray_min_launch\": true, \"tray_min_quit\": false, \"check_for_updates\": true, \"accent_color\": \"#7934FA\" , \"first_launch\": true}}")?;
    }
